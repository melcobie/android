...
public class QuizzFragment extends Fragment {
    ...
    public void setQuizzSet(){
        FragmentTransaction frgTrans = getParentFragmentManager().beginTransaction();
        frgTrans.replace(R.id.quizz_content, new StartQuizzFragment());
        frgTrans.commit();
    }
}